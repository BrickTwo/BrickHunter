      ...
      <b-row>
        ...
        <b-col cols="4">
          ...
          <!-- <b-row v-if="isAvailable">
            ...
            <b-col cols="2" class="p-0 text-right">{{ brick.maxAmount }}</b-col>
          </b-row> -->
          <b-row
          ...
          <!-- </b-overlay> -->
          <b-row>
            <span style="display: block; cursor: pointer" @click="setColor()">
        ...
        <b-col cols="1" class="p-0" style="margin: -9px; right: -18px">
          ...
          >
            <b-icon icon="plus-circle" font-scale="2" aria-hidden="true" />
          </b-button>
          <b-container v-else class="p-0 w-100 h-100 pos">
            ...
            ><b-row class="pl-1 pr-1" style="height: 33%">
              <b-col class="m-0 p-0 text-center" style="color: #dc3545">
                <b-icon
                  icon="trash"
                  style="cursor: pointer"
                  aria-hidden="true"
...
export default {
  ...
  computed: {
    ...
    bgimage() {
      ...
      return `background-image: url(https://brickhunter.blob.core.windows.net/parts/pab/${this.brick.itemNumber}.jpg), url('placeholder.jpg'); width: 100%; height: 100%; background-repeat: no-repeat; background-size: contain; background-position: center;`;
    },
    colorCode() {
