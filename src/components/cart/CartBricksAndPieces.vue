<template>
  <div class="container" ref="container">
    <n-space justify="right">
      <n-statistic label="Total Rows">225</n-statistic>
      <n-divider vertical />
      <n-statistic label="Total Parts">2950</n-statistic>
      <n-divider vertical />
      <n-statistic label="Price">
        147.63 <span style="font-size: 10px">USD</span>
      </n-statistic>
      <n-divider vertical />
    </n-space>
  </div>
  ...
  <n-collapse>
    <n-collapse-item name="1">
      <template #header>
        <div class="container" ref="container" style="width: 100%">
          <n-space justify="space-between">
            <n-space vertical justify="center" style="height: 100%">
              <div>Bricks & Pieces 1</div>
            </n-space>
            <n-space justify="right">
              <n-statistic label="Total Rows">150</n-statistic>
              <n-divider vertical />
              <n-statistic label="Total Parts">2000</n-statistic>
              <n-divider vertical />
              <n-statistic label="Price">
                105.50 <span style="font-size: 10px">USD</span>
              </n-statistic>
              <n-divider vertical />
            </n-space>
          </n-space>
    ...
    <n-collapse-item name="2">
      <template #header>
        <div class="container" ref="container" style="width: 100%">
          <n-space justify="space-between">
            <n-space vertical justify="center" style="height: 100%">
              <div>Bricks & Pieces 2</div>
            </n-space>
            <n-space justify="right">
              <n-statistic label="Total Rows">75</n-statistic>
              <n-divider vertical />
              <n-statistic label="Total Parts">950</n-statistic>
              <n-divider vertical />
              <n-statistic label="Price">
                42.13 <span style="font-size: 10px">USD</span>
              </n-statistic>
              <n-divider vertical />
            </n-space>
          </n-space>
