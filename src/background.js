...
browser.runtime.onMessage.addListener(
  function(request, sender, sendResponse, reject) {
    ...
    if (request.contentScriptQuery == "PickABrick") {
      ...
      var PickABrickQuery = {
        ...
        query: "mutation Login($forceCtLogin: Boolean) {\n  login(forceCtLogin: $forceCtLogin)\n}\n"
      }
      ...
      .then(logTabs => {
        ...
        browser.tabs.sendMessage( logTabs[0].id, {contentScriptQuery: "readCookie"})
        .then(authorization => {
      ...
      var PickABrickQuery = {
        ...
        query: "mutation RemoveAllPABLineItems($PABCartId: String!) {\n  removeAllPABLineItems(input: {PABCartId: $PABCartId}) {\n    id\n    taxedPrice {\n      totalGross {\n        formattedAmount\n        __typename\n      }\n      __typename\n    }\n    PABLineItems {\n      id\n      quantity\n      element {\n        id\n        __typename\n      }\n      totalPrice {\n        formattedAmount\n        __typename\n      }\n      __typename\n    }\n    __typename\n  }\n}\n"
      }
      ...
      var PickABrickQuery = {
        ...
        query: "mutation AddToPABCart($sku: String!, $quantity: Int, $PABCartId: String!) {\n  addPABItemToCart(input: {sku: $sku, quantity: $quantity, PABCartId: $PABCartId}) {\n    id\n    taxedPrice {\n      totalGross {\n        formattedAmount\n        __typename\n      }\n      __typename\n    }\n    PABLineItems {\n      ...PABLineItemData\n      __typename\n    }\n    __typename\n  }\n}\n\nfragment PABLineItemData on PABCartLineItem {\n  id\n  quantity\n  element {\n    id\n    name\n    primaryImage\n    __typename\n  }\n  price {\n    centAmount\n    currencyCode\n    __typename\n  }\n  elementVariant {\n    id\n    attributes {\n      designNumber\n      __typename\n    }\n    __typename\n  }\n  totalPrice {\n    formattedAmount\n    __typename\n  }\n  __typename\n}\n"
      }
